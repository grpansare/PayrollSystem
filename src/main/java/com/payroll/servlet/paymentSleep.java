...
public class paymentSleep extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PayrollDao p1=new PayrollDao();
		 ...
		 out.println("<option selected>Select Id to Generate Sleep</option>");
		 while(it.hasNext()) {
			 String eid=it.next();
		 ...
		 out.println("</select>");
		 response.setContentType("text/html");
		 RequestDispatcher rs=request.getRequestDispatcher("paymentSleep.html");
